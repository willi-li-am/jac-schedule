    ...
    <form ref={inputForm} className="flex flex-row text-white">
      <input
        ...
        onChange={(event) => {
          ...
          setTimeout(() => {
            setSuggestList(
              props.autoComplete.current.suggest(
      ...
      {props.inputCode.current.value === "" || !selected ? (
        ...
        <div
          className="bg-list absolute text-center border-2 border-t-0 border-darker"
          style={{
            marginTop: "40px",
            width: "205px",
            maxHeight: "200px",
        ...
        >
          {suggestList === null ? (
            <div
              style={{ padding: "5px", userSelect: "none", fontSize: "16px" }}
            >
              No results
            </div>
          ) : (
                ...
                suggestList.map((value, index) => (
                  <div
                    ...
                    style={{
                      ...
                      userSelect: "none",
                      fontSize: "16px",
                      color: props.coursePicked.includes(value)
                        ? "red"
                        : "white",
                    }}
                    key={index}
