...
function CourseInput(props: any){
    ...
    return(
        <form className="flex flex-row text-white">
            <input ref = {props.inputCode} onChange={(event) => props.inputCode.current.value = event.target.value} className="bg-dark" style={{width: "170px", marginTop: "5px", height: "35px", textAlign: "center"}}></input>
