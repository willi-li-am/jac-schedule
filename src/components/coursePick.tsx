...
const CoursePick = React.memo((prop: any) => {
  ...
  function handleCustomSubmit(event: any) {
    ...
    if (prop.courseList.includes(code))
      return alert("This course code already exists");
    let courseObj: any = {
      teacher: "DNE",
      rating: "DNE",
      title: code,
    ...
    if (code.length < 8)
      return alert("Please input a course with at least 8 characters ");
    ...
    if (
      ...
      if (timeEnd - timeStart < 100)
        return alert("Courses can't be this short, send me proof if there are");
    ...
    if (props.value["type"] === "custom" || !("details" in props.value)) {
      return (
        <div
          ...
          key={props.value["title"] + " " + props.value["section"]}
          style={{ color: props.color, fontSize: "15px" }}
        >
          <div className=" font-title flex items-center space-x-2">
            <FontAwesomeIcon
              title="course title"
              style={{ height: "13px", width: "13px", color: props.color }}
              icon={faTag}
            ></FontAwesomeIcon>
            <div style={{ fontSize: "13px" }}>{props.value["title"]}</div>
          </div>
          <div className=" flex items-center space-x-2">
            <FontAwesomeIcon
              ...
              icon={faHashtag}
            />{" "}
            <div style={{ fontSize: "13px" }}>{props.value["section"]}</div>
          </div>
    ...
    return (
      ...
      >
        {props.comp ? (
          <div
            key={
              props.value["title"] + props.value["section"] + "complementary"
            }
            className="flex flex-col"
          >
            <div
              key={
                ...
                "codeNameComplementary" +
                props.value["section"]
              }
              className="font-title flex items-center space-x-2"
            >
              <div className="" style={{ fontSize: "13px" }}>
                {props.value["courseCode"]}
              </div>
            </div>
            {"domain" in props.value ? (
              <div
                key={
                  props.value["courseCode"] +
                  "domainNameComplementary" +
                  props.value["section"]
                }
                className="font-title flex items-center space-x-2"
                style={{ fontSize: "12px" }}
              >
                <div className="">Domain: {props.value["domain"]}</div>
              </div>
            ) : (
              <></>
            )}
            {"ensemble" in props.value ? (
              <div
                key={
                  props.value["courseCode"] +
                  "ensembleNameComplementary" +
                  props.value["section"]
                }
                className="font-title flex items-center space-x-2"
                style={{ fontSize: "12px" }}
              >
                <div className="">Ensemble: {props.value["ensemble"]}</div>
              </div>
            ) : (
              <></>
            )}
        ...
        >
          <FontAwesomeIcon
            title="rating"
            style={{ height: "13px", width: "13px", color: props.colorm }}
            icon={faUser}
          />
          <div className="" style={{ fontSize: "13px" }}>
            {props.value["teacher"]}
        ...
        >
          <FontAwesomeIcon
            ...
            icon={faHashtag}
          />{" "}
          <div>{props.value["section"]}</div>
        </div>
        {props.value["rating"] == "DNE" ? (
          <div
            key={
              props.value["teacher"] +
              "ratingLine" +
          ...
          >
            <FontAwesomeIcon
              ...
              icon={faStar}
            />{" "}
            <div style={{ fontSize: "12px" }}>Rating Not Available</div>
          </div>
        ) : (
          <div>
            <div
            ...
            >
              ...
              <div style={{ fontSize: "13px" }}>
                {props.value["rating"]["rating"]} (
                {props.value["rating"]["reviews"]} reviews)
              </div>
              <a
                className="underline"
                target="_blank"
                href={props.value["rating"]["link"]}
              >
                <FontAwesomeIcon
                  title="link to ratemyprofessor"
                  style={{ height: "13px", width: "13px" }}
                  className="hover:text-link duration-150"
                  ...
                  {props.value["lab"]["rating"] == "DNE" ? (
                    ...
                    <div>
                      ...
                      >
                        ...
                        />
                        <div style={{ fontSize: "13px" }}>
                          {props.value["lab"]["rating"]["rating"]} (
                          {props.value["lab"]["rating"]["reviews"]} reviews)
                        </div>
                        <a
                          className="underline"
                          target="_blank"
                          href={props.value["lab"]["rating"]["link"]}
                        >
                          <FontAwesomeIcon
                            style={{ height: "13px", width: "13px" }}
                            className="hover:text-link duration-150"
        ...
        <div
          ...
          className="flex flex-col text-imp space-y-1"
        >
          {"details" in props.value && props.value["details"]["fee"] !== "" ? (
            <div
              key={
                props.value["teacher"] +
                "fee" +
              ...
              style={{ fontSize: "12px" }}
            >
              Fees: {props.value["details"]["fee"]}$
            </div>
          ) : (
            <></>
          )}
          {"details" in props.value &&
          props.value["details"]["restrict"] !== "" ? (
            <div
              key={
                props.value["teacher"] +
                "restrict" +
              ...
              style={{ fontSize: "12px" }}
            >
              Not for {props.value["details"]["restrict"]} students
            </div>
          ) : (
            <></>
          )}
          {"details" in props.value &&
          props.value["details"]["exclusive"] !== "" ? (
            <div
              key={
                props.value["teacher"] +
                "exclusive" +
              ...
              style={{ fontSize: "12px" }}
            >
              For {props.value["details"]["exclusive"]} students only
            </div>
          ) : (
            <></>
          )}
          {"details" in props.value &&
          props.value["details"]["blended"] !== "" ? (
            <div
              key={
                props.value["teacher"] +
                "blended" +
          ...
          props.value["details"]["intensive"] !== "" ? (
            <div
              ...
              style={{ fontSize: "12px" }}
            >
              {props.value["details"]["intensive"] === "Dawson Intensive" ? (
                <>
                  This section requires you to understand the policies and
                  procedures for{" "}
                  <a
                    className="text-link"
                    href="https://timetable.dawsoncollege.qc.ca/intensive-compressed-and-outdoor-education-courses/"
                    target="_blank"
                  >
          ...
          {"details" in props.value &&
          "comment" in props.value["details"] &&
          props.value["details"]["comment"] !== "" ? (
            <div
              key={
                props.value["teacher"] +
                "comment" +
              ...
              style={{ fontSize: "12px" }}
            >
              <span className="text-white font-title">Comment:</span>{" "}
              {props.value["details"]["comment"]}
            </div>
          ) : (
            <></>
    ...
    if (courseCode === "COMPLEMENTARY") {
      return (
        <div className="flex flex-col items-center">
          <div
            className="flex flex-row justify-between items-center bg-darker sticky top-0 text-white font-title"
            style={{
              width: "calc(30vw - 8px)",
              height: "40px",
              fontSize: "17px",
              zIndex: prop.coursePicked.length - props.listIndex,
            }}
          >
            <div className="flex items-center justify-center space-x-4">
              <div
                onClick={() => handleViewCourse(courseCode)}
                id={courseCode}
                className="ml-4 hover:cursor-pointer flex space-x-2 items-center"
              >
                <FontAwesomeIcon
                  icon={
                    viewCourse[courseCode] !== false
                      ? faChevronDown
                      : faChevronUp
                  }
                ></FontAwesomeIcon>
              ...
              <div className="relative z-2">
                <ColorPicker
                  ...
                  showColor={showColor}
                  handleColor={prop.handleColor}
                  code={courseCode}
                  setColorList={prop.setColorList}
                  colorList={prop.colorList}
                ></ColorPicker>
              </div>
            </div>

            <div
              className="font-title hover:cursor-pointer mr-4"
              onClick={() => {
                prop.removeCourseCode(courseCode);
              }}
              style={{ fontSize: "30px" }}
            >
              &times;
          ...
          {viewCourse[courseCode] !== false ? (
            <>
              {prop.courseInfo[props.listIndex].map(
                (value: any, index: number) => {
                  if (
                    courseCode in prop.courseIndexPicked &&
                    index !== prop.courseIndexPicked[courseCode]
                  )
                    return <></>;

                  if (
                    index === prop.courseIndexPicked[courseCode] &&
                    props.listIndex === prop.courseInfo.length - 1
                  ) {
                    return (
                      <div
                        key={value["courseCode"] + value["section"] + "course"}
                        className={
                          "p-2 pl-4 pr-8 overflow-hidden border-darker border-b-8 flex flex-row items-center justify-between"
                        }
                        style={{ width: "calc(30vw - 8px)" }}
                      >
                        <CourseInfo
                          comp={true}
                          value={value}
                        ...
                        <div
                          key={
                            value["courseCode"] + value["section"] + "button"
                          }
                          onClick={() => prop.removeCourse(value, courseCode)}
                  ...
                  if (
                    ...
                    return (
                      <div
                        key={value["courseCode"] + value["section"] + "course"}
                        className={
                          "p-2 pl-4 pr-8 overflow-hidden border-darker flex flex-row items-center justify-between"
                        }
                        style={{ width: "calc(30vw - 8px)" }}
                      >
                        {courseCode in prop.courseIndexPicked ? (
                            ...
                            {index === prop.courseIndexPicked[courseCode] ? (
                              <>
                                ...
                                <div
                                  ...
                                  onClick={() =>
                                    prop.removeCourse(value, courseCode)
                                  }
                                  className="hover:cursor-pointer flex items-center justify-center"
                                  style={{
                                    height: "40px",
                            ...
                            {compareTime(value) ? (
                              <>
                                ...
                                <div
                                  ...
                                  onMouseLeave={prop.removeHoverCourse}
                                  onMouseEnter={() =>
                                    prop.addHoverCourse(
                                      value,
                                      prop.coursePicked[props.listIndex],
                                    )
                                  }
                                  onClick={() =>
                                    prop.addCourse(
                                  ...
                                  className="hover:cursor-pointer grid"
                                  style={{
                                    height: "40px",
                                    width: "40px",
                                    color: "#ffffff",
                    ...
                    index === prop.courseInfo[props.listIndex].length - 1 &&
                    ...
                    return (
                      <div
                        key={value["courseCode"] + value["section"] + "course"}
                        className={
                          "p-2 pl-4 pr-8 overflow-hidden border-darker border-t-8 border-b-8 flex flex-row items-center justify-between"
                        }
                        style={{ width: "calc(30vw - 8px)" }}
                      >
                        {courseCode in prop.courseIndexPicked ? (
                  ...
                  return (
                    <div
                      key={value["courseCode"] + value["section"] + "course"}
                      className={
                        "p-2 pl-4 pr-8 overflow-hidden border-darker border-t-8 flex flex-row items-center justify-between"
                      }
                      style={{ width: "calc(30vw - 8px)" }}
                    >
                      {courseCode in prop.courseIndexPicked ? (
        ...
        >
          <div className="flex items-center justify-center space-x-4">
            ...
            >
              <FontAwesomeIcon
                icon={
                  viewCourse[courseCode] !== false ? faChevronDown : faChevronUp
                }
              ></FontAwesomeIcon>
              <div>{courseCode}</div>
            </div>
                ...
                if (
                  ...
                  return (
                    ...
                    >
                      ...
                      ></CourseInfo>
                      <div
                        key={value["courseCode"] + value["section"] + "button"}
                        onClick={() => prop.removeCourse(value, courseCode)}
                        className="hover:cursor-pointer flex items-center justify-center"
                        style={{
                          height: "40px",
                  ...
                  >
                    {courseCode in prop.courseIndexPicked ? (
                      ...
                      <>
                        {compareTime(value) ? (
                          <>
                            <CourseInfo comp={false} value={value}></CourseInfo>
                            <div
                              key={
                                value["courseCode"] +
                                value["section"] +
  ...
  async function handleFormSubmit(
    ...
    if (response.includes(code) && !prop.coursePicked.includes(code)) {
      ...
      setLoading(false);
      alert(
        "Course does not exist. If it does then it may have not been written in format: XXX-XXX-XX or it's a technical program course (add custom course)",
      );
    }
  }
    ...
    <div className="flex flex-row">
      ...
      <div className="sticky" style={{ zIndex: "1000" }}>
        {loading ? (
          ...
          >
            <div className="absolute text-white font-title z-10">
              <div
                style={{ width: "100vw", height: "100vh", fontSize: "5rem" }}
                className="flex items-center justify-center"
              >
                <BeatLoader speedMultiplier={1} color="white" size={40} />
              </div>
            </div>
            <div
              className="bg-darker absolute opacity-60"
        ...
        >
          <div
            className="flex items-center font-title text-white select-none hover:cursor-pointer"
            style={{ fontSize: "15px" }}
            onClick={() => setViewCourseInput(!viewCourseInput)}
          >
            {viewCourseInput ? (
              <FontAwesomeIcon
                style={{
          ...
          <div
            ...
            style={{ display: viewCourseInput ? "flex" : "none" }}
          >
            <CourseInput
              school={prop.school}
              coursePicked={prop.coursePicked}
            ...
            >
              <div
                ...
                onClick={() => setViewCustomCourse(!viewCustomCourse)}
              >
                {viewCustomCourse ? (
                  <FontAwesomeIcon
                    style={{
              ...
              <div
                ...
                style={{
                  height: "291px",
                  display: viewCustomCourse ? "flex" : "none",
                }}
              >
                <input
                  ref={customCourse["code"]}
                  onChange={(event) => {
                    handleCustomInput(event, 0);
                  }}
                  className="bg-dark text-white outline-none"
                  style={{
                    height: "30px",
                    textAlign: "center",
                    width: "143px",
                ...
                ></input>
                <div
                  className="text-white flex items-center space-x-1 mr-11"
                ...
                <button
                  className="bg-nav font-title text-white"
                  style={{
                    height: "40px",
                    width: "50px",
                    marginTop: "15px",
        ...
        <div
          className="bg-list flex flex-col overflow-y-scroll items-center sticky"
          style={{
            zIndex: -1,
            width: "30vw",
            height: viewCourseInput
              ? viewCustomCourse
                ? "calc(100vh - 476px)"
                : "calc(100vh - 185px)"
              : "calc(100vh - 102.5px)",
        ...
        >
          {prop.courseInfo === "" || prop.courseInfo.length === 0 ? (
            <div
              className="bg-darker sticky top-0 text-white font-title pt-2 pl-3 pb-2"
              style={{ width: "calc(30vw - 8px)", fontSize: "20px" }}
            >
              Course List{" "}
              <span
          ...
          {prop.courseInfo !== "" && prop.courseInfo.length !== 0 ? (
            <div>
              {prop.courseInfo.map((value: any, index: number) => {
                return (
                  <div key={"CourseWrap" + index} className="text-white">
                    <CourseList listIndex={index}></CourseList>
                  </div>
                );
              })}
            </div>
      ...
      <Schedule
        hoverCourse={prop.hoverCourse}
        clearCourse={prop.clearCourse}
        addHoverCourse={prop.addHoverCourse}
        removeHoverCourse={prop.removeHoverCourse}
        autoComplete={prop.autoComplete}
        handleColor={prop.handleColor}
        colorList={prop.colorList}
        setColorList={prop.setColorList}
        removeCourseCode={prop.removeCourseCode}
        courseInfoCache={prop.courseInfoCache}
        setCourseInfoCache={prop.setCourseInfoCache}
        lastPage={prop.lastPage}
        setLastPage={prop.setLastPage}
        removeCourse={prop.removeCourse}
        addCourse={prop.addCourse}
        courseIndexPicked={prop.courseIndexPicked}
        setCourseIndexPicked={prop.setCourseIndexPicked}
        schedule={prop.schedule}
        setSchedule={prop.setSchedule}
        courseList={prop.courseList}
        setCourseList={prop.setCourseList}
        inputCode={inputCode}
        courseInfo={prop.courseInfo}
        setCourseInfo={prop.setCourseInfo}
        coursePicked={prop.coursePicked}
        setCoursePicked={prop.setCoursePicked}
        setUpdate={setUpdate}
        update={update}
      />
    </div>
