            ...
            <div className= "flex flex-col" key = {props.value["teacher"] + " " + props.value["title"] + " " + props.value["section"]} style={{color: props.color, fontSize: "15px"}}>
                ...
                {!("lab" in props.value)||!("teacher" in props.value["lab"]) ? <></> : <>
                 ...
                 <div key = {props.value["teacher"] + "details group" + props.value["courseCode"] + props.value["section"]} className="flex flex-col text-imp space-y-1">
                    ...
                    {"details" in props.value && "comment" in props.value["details"] && props.value["details"]["comment"] !== ""? <div key = {props.value["teacher"] + "comment" + props.value["courseCode"] + props.value["section"]} style={{fontSize: "12px"}}><span className = "text-white font-title">Comment:</span> {props.value["details"]["comment"]}</div> : <></>}
                </div>
