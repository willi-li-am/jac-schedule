...
function App() {
  //add routes to make current page stuff so if reload, still on schedule page
  ...
  function removeCourseCode(code: string) {
    ...
    if (code in courseIndexPicked) {
      ...
      for (const day in scheduleObj) {
        const targetElementIndex = scheduleObj[day].indexOf(
          course["schedule"][day],
        );
  ...
  function NavBarFull() {
    return (
      <NavBar
        ...
        handleLogin={handleLoginSetting}
        loggedIn={loggedIn}
      ></NavBar>
    );
  }
          ...
          <Route
            ...
            element={
              <div
                style={{
                  height: "100vh",
                  overflowY: showDisclaimer ? "hidden" : "auto",
                }}
              >
                <Disclaimer
              ...
              <div style={{ overflow: "hidden" }}>
                ...
                <div className="flex">
                  <CoursePick
                    ...
                    addHoverCourse={addHoverCourse}
                    removeHoverCourse={removeHoverCourse}
                    autoComplete={autoComplete}
                    handleColor={handleColor}
                    colorList={colorList}
                    setColorList={setColorList}
                    removeCourseCode={removeCourseCode}
                    courseInfoCache={courseInfoCache}
                    setCourseInfoCache={setCourseInfoCache}
                    lastPage={lastPage}
                    setLastPage={setLastPage}
                    removeCourse={removeCourse}
                    addCourse={addCourse}
                    courseIndexPicked={courseIndexPicked}
                    setCourseIndexPicked={setCourseIndexPicked}
                    schedule={schedule}
                    ...
                    setCoursePicked={setCoursePicked}
                    setUpdate={setUpdate}
                    update={update}
                  ></CoursePick>
                </div>
